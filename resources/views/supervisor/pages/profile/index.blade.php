...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
      <div class="col-md-4">
        @livewire('supervisor.pages.profile.get-data')
      </div>
      ...
      <div class="col-md-8">
        ...
        @include('supervisor.pages.profile.partials.update-password-form')
  ...
  @livewire('supervisor.pages.profile.partials.edit')

...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="flex justify-content-between  mb-4">
      <h3 class="fw-bolder fs-3">Roles of Admins</h3>
      @include('admin.pages.roles.admins.partials.create-modal')
    </div>
    <div class="row">
      <div class="col-md-12">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @include('admin.pages.roles.admins.partials.show-modal')
                        @include('admin.pages.roles.admins.partials.edit-modal')
                        @include('admin.pages.roles.admins.partials.verify-modal')
                        @include('admin.pages.roles.admins.partials.delete-modal')

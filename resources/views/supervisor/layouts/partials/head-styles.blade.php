...
<!-- Favicon -->
<link rel="icon" type="image/x-icon" href="{{ URL::asset(getSetting('favicon')) }}" />
...
<link rel="stylesheet" href="{{ URL::asset('assets/admin') }}/vendor/fonts/boxicons.css" />
...
<link rel="stylesheet" href="{{ URL::asset('assets/admin') }}/vendor/libs/apex-charts/apex-charts.css" />

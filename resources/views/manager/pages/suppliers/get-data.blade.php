        ...
        <div class="card mb-2 ">
            ...
            <div class="card-title d-flex justify-content-between flex-wrap">
                <div class="d-flex justify-content-start mt-3 ms-3">
                    ...
                    @include('manager.pages.suppliers.partials.import')
                    @include('manager.pages.suppliers.partials.delete-selected')
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if(manager()->can('supplier-edit'))
                                                <a class="dropdown-item" href="javascript:void(0);"
                                                    wire:click="$dispatch('supplierUpdate', { id: {{ $value->id }} })"
                                                >
                                            ...
                                            @if(manager()->can('supplier-delete'))
                                                <a class="dropdown-item" href="#"
                                                    wire:click.prevent="$dispatch('supplierDelete', { id: {{ $value->id }} })"
                                                >

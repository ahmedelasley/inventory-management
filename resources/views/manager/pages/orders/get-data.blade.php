                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(manager()->can('transfer-read'))
                                            <a href="{{ route('manager.orders.create.order', ['order' => $value]) }}"><i class='bx bx-receipt'></i><strong>{{ $value->code }}</strong></a>
                                        @else
                                    ...
                                    <td>
                                        {{-- <a class="btn btn-primary btn-sm" href="{{ route('manager.orders.create.order', ['order' => $value]) }}">
                                            <i class="bx bx-show me-1"></i> Show
                                        </a> --}}
                                        @if(manager()->can('transfer-show-transactions'))
                                            <a class="btn btn-primary btn-sm" href="{{ route('manager.orders.show.transaction', ['order' => $value]) }}">

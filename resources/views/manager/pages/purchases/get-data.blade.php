                ...
                <div class="d-flex justify-content-start mt-3 ms-3">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item {{ $field == 'supplier' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchField('supplier')">Supplier</a></li>
                ...
                <div class="table-responsive text-wrap"  style="height : calc(100vh - 420px)">
                    <table class="table table-striped table-hover table-sm text-center">
                        ...
                        <tr>
                            ...
                            <th class="fw-bolder fs-6">Supplier</th>
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @forelse ($data as $value)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(manager()->can('purchasing-read'))
                                            <a href="{{ route('manager.purchases.create.purchase', ['purchase' => $value]) }}">
                                    ...
                                    <td>
                                        @if(manager()->can('purchasing-show-transactions'))
                                            <a class="btn btn-primary btn-sm" href="{{ route('manager.purchases.create.purchase', ['purchase' => $value]) }}">

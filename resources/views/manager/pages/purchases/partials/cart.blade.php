<div class="card">
    @livewire('manager.pages.purchases.partials.edit-product', ['purchase' => $purchase])
    @livewire('manager.pages.purchases.partials.delete-product', ['purchase' => $purchase])
    ...
    <div class="card-body">
        @if(manager()->can('purchasing-all-items'))
                ...
                <table class="table table-striped table-hover table-sm text-center">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr  wire:key="product-{{$value->id}}">
                            ...
                            <td>
                                @if($purchase->status == 'Pending')
                                    @if(manager()->can('purchasing-edit-item'))
                                    ...
                                    @endif
                                    @if(manager()->can('purchasing-delete-item'))

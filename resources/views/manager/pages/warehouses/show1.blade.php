...
<div class="container-fluid flex-grow-1 container-p-y">
      <div class="d-flex justify-content-between  mb-2">
            ...
            <a href="{{ route('manager.warehouses.index') }}" class="btn btn-primary btn-round btn-sm d-block">
                        ...
                        <div class="table-responsive text-wrap"  style="height : calc(100vh - 420px)">
                            <table class="table table-striped table-hover table-sm text-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('manager.warehouses.show.transaction', $value) }}">{{ $value->product->name }}</a></td>

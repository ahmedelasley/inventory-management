<div class="card">
    @livewire('manager.pages.sales.partials.edit-product', ['sale' => $sale])
    @livewire('manager.pages.sales.partials.delete-product', ['sale' => $sale])
                            ...
                            <tr wire:key="product-{{ $value->id }}">
                                ...
                                <td>
                                    <div class="d-flex justify-content-between">
                                        @if($sale->status == 'Open' && $sale->type == 'Pending' )
                                            @if(manager()->can('sale-increase-qty-item'))
                                            ...
                                            @if(manager()->can('sale-decrease-qty-item'))
                                ...
                                @if($sale->status == 'Open' && $sale->type == 'Pending')
                                    <td>
                                        @if(manager()->can('sale-delete-item'))

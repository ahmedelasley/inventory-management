                ...
                <div class="d-flex justify-content-start mt-3 ms-3">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item {{ $field == 'restaurant' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchField('restaurant')">Restaurant</a></li>
                          <li><a class="dropdown-item {{ $field == 'client' ? 'active' : ''}}" href="javascript:void(0);" wire:click="searchField('client')">Client</a></li>
                        </ul>
                    </div>
                    <div class="btn-group">
                        <button
                ...
                <div class="table-responsive text-wrap"  style="height : calc(100vh - 420px)">
                    <table class="table table-striped table-hover table-sm text-center">
                        ...
                        <tr>
                            ...
                            <th class="fw-bolder fs-6">Client</th>
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @forelse ($data as $value)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(manager()->can('sale-read'))
                                            <a href="{{ route('manager.sales.create.sale', ['sale' => $value]) }}"><i class='bx bx-receipt'></i><strong>{{ $value->code }}</strong></a>
                                        @else
                                    ...
                                    <td>
                                        @if(manager()->can('sale-show.transactions'))
                                        <a class="btn btn-primary btn-sm" href="{{ route('manager.sales.show.transaction', ['sale' => $value]) }}">

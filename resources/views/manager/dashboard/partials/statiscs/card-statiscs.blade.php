        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-12 mb-4">
                <div class="card bg-primary p-0">
                    <div class="card-body">
                        <h5 class="text-white text-center">Welcome 🎉 in Restaurant Manager Panel</h5>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="avatar flex-shrink-0 me-1">
                        <img src="{{ URL::asset('assets/admin') }}/img/icons/unicons/supplier.png" alt="chart success" class="rounded  h-75 w-75"/>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-4">
                ...
                <div class="card-body">
                    <div class="card-title d-flex  justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ URL::asset('assets/admin') }}/img/icons/unicons/products.png" alt="chart success" class="rounded  h-75 w-75"/>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-4">
                ...
                <div class="card-body">
                    <div class="card-title d-flex  justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ URL::asset('assets/admin') }}/img/icons/unicons/shopping-cart.png" alt="chart success" class="rounded  h-75 w-75"/>
                    </div>
                    <h6 class="fw-semibold d-block mb-1 text-start">Purchases</h6>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12 mb-4">
                ...
                <div class="card-body">
                    <div class="card-title d-flex  justify-content-between">
                    <div class="avatar flex-shrink-0">
                        <img src="{{ URL::asset('assets/admin') }}/img/icons/unicons/transfer.png" alt="chart success" class="rounded  h-75 w-75"/>
                    </div>
                    <h6 class="fw-semibold d-block mb-1 text-start">Transfers</h6>
                    </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="user-progress d-flex justify-content-evenly">
                            <h4 class="card-title mb-2 text-center">{{ $totalQty }}</h4>
                            <h4 class="card-title mb-2 text-center">{{ number_format($totalCost, 2) }} <small>SAR</small></h4>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <ul class="p-0 m-0">
                            <!-- Restaurants -->
                            <li class="d-flex mb-1 border-bottom border-light">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                <div class="card" style="max-height: 600px;">
                    <div class="card-body" >
                        <h5 class="card-title mb-0">Kitchens Chart </h5>

                        <div style="max-height: 500px">
                            {!! $stackedBarChartKitchens->render() !!}
                        </div>
                    </div>
                </div>
            </div>

            <!-- Bar Chart Warehouses -->
            <div class="col-lg-12 col-md-12 col-12 mb-4">
                <div class="card" style="max-height: 550px;">
                    <div class="card-body" >
                        <h5 class="card-title mb-0">Warehouses Chart </h5>

                        <div style="max-height: 450px">
                            {!! $stackedBarChartWarehouses->render() !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                <div class="card" style="max-height: 500px;">
                    <div class="card-body" >
                    <h5 class="card-title mb-0">Inventory Chart </h5>

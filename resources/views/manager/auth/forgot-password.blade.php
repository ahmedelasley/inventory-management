...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('manager.password.email') }}" method="POST">
                @csrf
            ...
            <div class="mb-3">
                <p class="text-center">
                    <a href="{{ route('manager.login') }}"><i class="bx bx-chevron-left scaleX-n1-rtl bx-sm"></i><span>Back to Login</span></a>
                </p>
            </div>

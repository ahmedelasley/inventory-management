        ...
        <div>
            ...
            <script type="text/javascript">
                function openPrintReceipt(id) {
                    window.open(
                        "{{ URL::to('keeper/purchases/print/purchase/') }}/" + id ,
                        "_blank",
            ...
            @if($purchase->status == 'Pending')
                ...
                @livewire('keeper.pages.purchases.partials.edit', ['purchase' => $purchase], key('purchase-edit-'.time()))
                ...
                @livewire('keeper.pages.purchases.partials.convert-purchase', ['purchase' => $purchase], key('purchase-convert-'.time()))
                ...
                @livewire('keeper.pages.purchases.partials.save', ['purchase' => $purchase], key('purchase-save-'.time()))
                ...
                @livewire('keeper.pages.purchases.partials.delete', ['purchase' => $purchase], key('purchase-delete-'.time()))
            @endif
        </div>
    </div>
</div>
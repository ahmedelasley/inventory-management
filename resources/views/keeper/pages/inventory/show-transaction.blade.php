...
<div class="container-fluid flex-grow-1 container-p-y">
      <div class="d-flex justify-content-between  mb-2">
            <h5 class="fw-bolder fs-5">{{ $data->warehouse->name }} Transactions</h5>
            <a href="{{ route('keeper.warehouses.index') }}" class="btn btn-primary btn-round btn-sm d-block">
                ...
                <div class="card mb-2 ">
                    ...
                    <div class="card-title d-flex justify-content-between flex-wrap">
                        <div class="d-flex justify-content-start mt-3 ms-3">
                            ...
                            @include('keeper.pages.warehouses.partials.import')
                            @include('keeper.pages.warehouses.partials.delete-selected') --}}
                        ...
                        <div class="table-responsive text-wrap"  style="height : calc(100vh - 420px)">
                            <table class="table table-striped table-hover table-sm text-center">
                                ...
                                <tbody class="table-border-bottom-0">
                                    @forelse ($data->movements as $value)

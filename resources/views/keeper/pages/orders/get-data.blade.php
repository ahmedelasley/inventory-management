                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @forelse ($data as $value)
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('keeper.orders.create.order', ['order' => $value]) }}"><strong>{{ $value->code }}</strong></a></td>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ route('keeper.orders.show.transaction', ['order' => $value]) }}">

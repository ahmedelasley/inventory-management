<div class="col-lg-5 mb-4 order-0">
    <div class="card bg-primary">
      <div class="d-flex align-items-end row">
        <div class="col-sm-8">
          <div class="card-body">
            <h4 class="card-title text-white">Welcome <b>{{ Auth::guard('keeper')->user()->name }}</b> 🎉 in Panel</h4>
            <p class="mb-2 text-white">You have control over your  <b>{{ Auth::guard('keeper')->user()->warehouse?->name }}</b></p>

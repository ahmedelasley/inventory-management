      ...
      <div class="row justify-content-center">
            <div class="col-md-5">
                  {{-- <div class="d-flex justify-content-between">
                        <h6 class="p-2 rounded-pill {{ $sale->type == 'Pending' ? 'bg-warning text-center text-white' : '' }}" ><img src="{{ URL::asset('assets/admin') }}/img/icons/unicons/pending.png" alt="User" style="width: 20px; height: 20px;"/></h6>
                  ...
                  @livewire('admin.pages.sales.partials.title', ['sale' => $sale])
                  @livewire('admin.pages.sales.partials.cart', ['sale' => $sale])
            </div>
            <div class="col-md-7">
                  @livewire('admin.pages.sales.partials.products' , ['sale' => $sale])
            </div>

    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="row mb-3">
                ...
                @foreach (\Spatie\Permission\Models\Permission::select('guard_name', 'type', 'type_name')->where('guard_name', 'supervisor')->groupBy('guard_name', 'type', 'type_name')->get() as $data)

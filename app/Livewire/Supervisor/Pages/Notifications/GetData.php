...
class GetData extends Component
{
    ...
    public function render()
    {
        ...
        $data = Auth::guard('supervisor')->user()->notifications()->where("data->details->$this->field", 'like', '%' . $this->search . '%')->latest()->paginate(20);
        return view('supervisor.pages.notifications.get-data', [
            'data' => $data,
        ]);
    }
}

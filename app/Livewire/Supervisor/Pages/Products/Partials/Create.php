...
namespace App\Livewire\Supervisor\Pages\Products\Partials;

use Livewire\Component;
use App\Models\Category;
use App\Models\Product;
use App\Livewire\Supervisor\Pages\Products\GetData;
...
class Create extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            $validatedData['created_id'] = Auth::guard('supervisor')->user()->id;
    ...
    public function render()
    {
        ...
        return view('supervisor.pages.products.partials.create', [
            'data' => $data,
        ]);
    }
}

...
class Create extends Component
{
    ...
    {
        return (new KeeperRequest())->rules();
    } 
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Query Create
            $keeper = Keeper::create($validatedData);
            // Step 2: Assign Role for keeper
            if(isset($validatedData['role'])) $keeper->assignRole($validatedData['role']);
    ...
    public function render()
    {
        ...
        return view('admin.pages.keepers.partials.create', [
            'roles' => $roles,
        ]);
    }
}

...
namespace App\Livewire\Keeper\Pages\Purchases;
...
class GetData extends Component
{
    ...
    public function render()
    {
        ...
        $data = Purchase::with(['warehouse', 'supplier', 'createable'])->where('warehouse_id', Auth::guard('keeper')->user()->warehouse->id);
        ...
        return view('keeper.pages.purchases.get-data', [
            'data' => $data,
        ]);
    }
}

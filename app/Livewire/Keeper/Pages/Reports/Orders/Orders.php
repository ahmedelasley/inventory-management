...
namespace App\Livewire\Keeper\Pages\Reports\Orders;
...
class Orders extends Component
{
    ...
    {
        $data = Order::with(['kitchen', 'warehouse', 'products', 'createable'])->ofKitchen(Auth::guard('keeper')->user()->kitchen->id);
        ...
        return view('keeper.pages.reports.orders.orders', [
            'data' => $data,
        ]);
    }
}

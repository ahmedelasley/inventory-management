...
namespace App\Livewire\Keeper\Pages\Orders;
...
class GetData extends Component
{
    ...
    public function render()
    {
        ...
        $data = Order::with(['kitchen', 'warehouse', 'createable'])->where('warehouse_id', Auth::guard('keeper')->user()->warehouse->id)->where('type', '!=', 'Pending');
        ...
        return view('keeper.pages.orders.get-data', [
            'data' => $data,
        ]);
    }
}

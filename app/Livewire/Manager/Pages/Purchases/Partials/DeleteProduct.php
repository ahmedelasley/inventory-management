...
class DeleteProduct extends Component
{
    ...
    protected $listeners = ['purchaseItemDelete'];
    ...
    public function submit()
    {
        ...
        try {
            ...
            $this->purchase->update([
                ...
                'quantities' => $this->purchase->quantities - $this->item->quantity ,
                'subtotal' => $this->purchase->subtotal - ($this->item->quantity * $this->item->cost ) ,
            ]);
    ...
    {
        return view('manager.pages.purchases.partials.delete-product');
    }
}

...
class Send extends Component
{
    ...
    public function saleSend($id)
    {
        ...
        // Open modal
        $this->dispatch('sendSaleModalToggle');
    }
...
// dd($product->stock->product_id);
            ...
            // Hide modal
            $this->dispatch('sendSaleModalToggle');
            $this->dispatch('refreshTitleSend'); 
    ...
    {
        return view('manager.pages.sales.partials.send');
    }
}

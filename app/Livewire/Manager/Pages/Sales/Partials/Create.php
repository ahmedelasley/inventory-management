...
class Create extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Associate the sale with the manager user
            ...
            // return redirect()->route('manager.sales.complete-create', ['sale' => $sale]);
            return redirect()->route('manager.sales.create.sale', ['sale' => $sale]);
...
// dd($restaurants->kitchen());
        ...
        return view('manager.pages.sales.partials.create', [

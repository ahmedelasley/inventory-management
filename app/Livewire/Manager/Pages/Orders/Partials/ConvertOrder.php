...
use App\Livewire\Manager\Pages\Orders\GetData;
...
class ConvertOrder extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Notify the user
            foreach (Manager::where('id', '!=', Auth::guard('manager')->user()->id)->get() as $manager) {
                $manager->notify(new TrackOrderStatus($details));
            }
    ...
    {
        return view('manager.pages.orders.partials.convert-order');
    }
}

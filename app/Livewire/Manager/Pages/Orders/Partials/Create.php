...
class Create extends Component
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Associate the order with the manager user
            ...
            // return redirect()->route('manager.orders.complete-create', ['order' => $order]);
            return redirect()->route('manager.orders.create.order', ['order' => $order]);
...
// dd($restaurants->kitchen());
        ...
        return view('manager.pages.orders.partials.create', [

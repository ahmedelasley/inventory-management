...
namespace App\Livewire\Manager\Pages\Clients\Partials;

use Livewire\Component;
use App\Models\Manager;
use App\Models\Client;
use App\Livewire\Manager\Pages\Clients\GetData;
...
// dd(Client::latest()->first()->code);
            ...
            // $validatedData['created_id'] = Auth::guard('manager')->user()->id;
    ...
    public function render()
    {
        ...
        return view('manager.pages.clients.partials.create');
    }
}
